...
array=(
    ...
    0 1 ${tmp_courses_path}/courses/nfs/nfs.md courses/nfs/nfs.html "nfs文件系统"
        1 1 ${tmp_courses_path}/courses/nfs/nfs-introduction.md courses/nfs/nfs-introduction.html "nfs简介"
        1 1 ${tmp_courses_path}/courses/nfs/nfs-environment.md courses/nfs/nfs-environment.html "nfs环境"
        1 1 ${tmp_courses_path}/courses/nfs/nfs-client-struct.md courses/nfs/nfs-client-struct.html "nfs client数据结构"
        1 1 ${tmp_courses_path}/courses/nfs/pnfs.md courses/nfs/pnfs.html "Parallel NFS (pNFS)"
        1 1 ${tmp_courses_path}/courses/nfs/nfsd.md courses/nfs/nfsd.html "nfs server (nfsd)"
        1 1 ${tmp_courses_path}/courses/nfs/nfs-procedures.md courses/nfs/nfs-procedures.html "nfs Procedures和Operations"
        1 1 ${tmp_courses_path}/courses/nfs/nfs-filehandle.md courses/nfs/nfs-filehandle.html "nfs文件句柄"
        1 1 ${tmp_courses_path}/courses/nfs/nfs-debug.md courses/nfs/nfs-debug.html "nfs调试方法"
        1 1 ${tmp_courses_path}/courses/nfs/nfs-patches.md courses/nfs/nfs-patches.html "nfs补丁分析"
            # 我写的补丁
    ...
    0 1 ${tmp_courses_path}/courses/smb/smb.md courses/smb/smb.html "smb文件系统"
        1 1 ${tmp_courses_path}/courses/smb/smb-introduction.md courses/smb/smb-introduction.html "smb简介"
        1 1 ${tmp_courses_path}/courses/smb/smb-environment.md courses/smb/smb-environment.html "smb环境"
        1 1 ${tmp_courses_path}/courses/smb/ksmbd.md courses/smb/ksmbd.html "smb server (ksmbd)"
        1 1 ${tmp_courses_path}/courses/smb/smb-client-struct.md courses/smb/smb-client-struct.html "smb client数据结构"
        1 1 ${tmp_courses_path}/courses/smb/smb-debug.md courses/smb/smb-debug.html "smb调试方法"
        1 1 ${tmp_courses_path}/courses/smb/smb-patches.md courses/smb/smb-patches.html "smb补丁分析"
        1 1 ${tmp_courses_path}/courses/smb/smb-refactor.md courses/smb/smb-refactor.html "smb代码重构"
            # 我写的补丁
