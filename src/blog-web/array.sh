...
comm_array=(
	...
	0 1 courses/kernel/kernel.md ~ "Linux内核课程"
		...
		1 1 courses/kernel/introduction.md ~ "内核简介"
		1 1 courses/kernel/dev-environment.md ~ "内核开发环境"
		1 1 courses/kernel/book.md ~ "内核书籍推荐"
		1 1 courses/kernel/community.md ~ "内核社区"
		1 1 courses/kernel/test.md ~ "内核测试工具"
		1 1 courses/kernel/fs.md ~ "文件系统"
		1 1 courses/kernel/debug.md ~ "内核调试方法"
		1 1 courses/kernel/mm.md ~ "内存管理"
		1 1 courses/kernel/process.md ~ "进程管理和调度"
		1 1 courses/kernel/interrupt.md ~ "中断"
		1 1 courses/kernel/syscall.md ~ "系统调用"
		1 1 courses/kernel/block.md ~ "块I/O层"
		1 1 courses/kernel/timer.md ~ "定时器"
		1 1 courses/kernel/bpf.md ~ "BPF"
		1 1 courses/kernel/sync.md ~ "内核同步"
		1 1 courses/kernel/network.md ~ "网络"
		1 1 courses/kernel/mptcp.md ~ "MPTCP"
		1 1 courses/kernel/patch.md ~ "内核补丁分析"
			# 我写的补丁
	...
	0 1 courses/smb/smb.md ~ "smb文件系统"
		...
		1 1 courses/smb/environment.md ~ "smb环境"
	...
	0 1 courses/algorithm/algorithms.md ~ "算法"
		1 1 courses/algorithm/video.md ~ "算法课程配套视频"
		1 1 courses/algorithm/book.md ~ "算法书籍推荐"
		1 1 courses/algorithm/dynamic-programming.md ~ "动态规划"
		1 1 courses/algorithm/sort.md ~ "排序算法"
		1 1 courses/algorithm/heap-priority-queue.md ~ "堆（优先队列）"
		1 1 courses/algorithm/prefix-sum.md ~ "前缀和、差分"
		1 1 courses/algorithm/hash-table.md ~ "哈希表"
		1 1 courses/algorithm/monotonic-stack.md ~ "单调栈"
		1 1 courses/algorithm/greedy.md ~ "贪心"
		1 1 courses/algorithm/backtracking.md ~ "回溯"
		1 1 courses/algorithm/binary-search.md ~ "二分查找"
		1 1 courses/algorithm/union-find.md ~ "并查集"
		1 1 courses/algorithm/trie.md ~ "前缀树（字典树）"
		1 1 courses/algorithm/recursion.md ~ "递归"
		1 1 courses/algorithm/sliding-window.md ~ "滑动窗口"
		1 1 courses/algorithm/breadth-first-search.md ~ "广度优先搜索"
		1 1 courses/algorithm/depth-first-search.md ~ "深度优先搜索"
		1 1 courses/algorithm/string.md ~ "字符串"
		1 1 courses/algorithm/others.md ~ "未分类的内容"
	0 1 courses/godot/godot.md ~ "Godot游戏开发"
		1 1 courses/godot/introduction.md ~ "Godot简介"
		1 1 courses/godot/demo.md ~ "Godot官方demo"
