...
comm_array=(
	...
	0 1 courses/kernel/kernel.md "$(comm_tmp_src_path)" "Linux内核课程"
		1 1 courses/kernel/kernel-introduction.md "$(comm_tmp_src_path)" "内核简介"
		1 1 courses/kernel/kernel-dev-environment.md "$(comm_tmp_src_path)" "内核开发环境"
		1 1 courses/kernel/kernel-book.md "$(comm_tmp_src_path)" "内核书籍推荐"
		1 1 courses/kernel/kernel-source.md "$(comm_tmp_src_path)" "内核源码介绍"
		1 1 courses/kernel/kernel-fs.md "$(comm_tmp_src_path)" "文件系统"
		1 1 courses/kernel/kernel-debug.md "$(comm_tmp_src_path)" "内核调试方法"
		1 1 courses/kernel/kernel-mm.md "$(comm_tmp_src_path)" "内存管理"
		1 1 courses/kernel/kernel-process.md "$(comm_tmp_src_path)" "进程管理和调度"
		1 1 courses/kernel/kernel-interrupt.md "$(comm_tmp_src_path)" "中断"
		1 1 courses/kernel/kernel-syscall.md "$(comm_tmp_src_path)" "系统调用"
		1 1 courses/kernel/kernel-timer.md "$(comm_tmp_src_path)" "定时器"
		1 1 courses/kernel/kernel-bpf.md "$(comm_tmp_src_path)" "BPF"
		1 1 courses/kernel/kernel-patches.md "$(comm_tmp_src_path)" "内核补丁分析"
			# 我写的补丁
	...
	0 1 courses/nfs/nfs.md "$(comm_tmp_src_path)" "nfs文件系统"
		1 1 courses/nfs/nfs-introduction.md "$(comm_tmp_src_path)" "nfs简介"
		1 1 courses/nfs/nfs-environment.md "$(comm_tmp_src_path)" "nfs环境"
		1 1 courses/nfs/nfs-client-struct.md "$(comm_tmp_src_path)" "nfs client数据结构"
	...
	0 1 courses/smb/smb.md "$(comm_tmp_src_path)" "smb文件系统"
		...
		1 1 courses/smb/ksmbd.md "$(comm_tmp_src_path)" "smb server (ksmbd)"
		1 1 courses/smb/smb-client-struct.md "$(comm_tmp_src_path)" "smb client数据结构"
		1 1 courses/smb/smb-debug.md "$(comm_tmp_src_path)" "smb调试方法"
		1 1 courses/smb/smb-patches.md "$(comm_tmp_src_path)" "smb补丁分析"
		1 1 courses/smb/smb-refactor.md "$(comm_tmp_src_path)" "smb代码重构"
		1 1 courses/smb/smb-others.md "$(comm_tmp_src_path)" "smb未分类的内容"
			# 我写的补丁
