...
echo "mainline inclusion"
echo "from mainline-${version}"
echo "commit ${full_commit_id}"
echo "category: bugfix"
echo "bugzilla: "
echo "CVE: NA"
echo
echo "Reference: https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/commit/?id=${full_commit_id}"
echo
echo "--------------------------------"
echo
echo "Conflicts:"
