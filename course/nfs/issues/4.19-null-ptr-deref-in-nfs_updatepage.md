...
要说明一下，maintainer自己都没想好这个机制有没问题，具体可以参考我的另一篇文章: [《nfs回写错误处理不正确的问题》](https://chenxiaosong.com/course/nfs/patches/nfs-handle-writeback-errors-incorrectly.html)，这里就不做过多展开。
...
4.19代码合入补丁[0001-reproduce-4.19-null-ptr-deref-in-nfs_updatepage.patch](https://gitee.com/chenxiaosonggitee/blog/blob/master/course/nfs/issues/0001-reproduce-4.19-null-ptr-deref-in-nfs_updatepage.patch)。
...
打上这个补丁后是有问题的，会进入死循环，具体请查看[《4.19 nfs_wb_page() soft lockup的问题》](https://chenxiaosong.com/course/nfs/issues/4.19-nfs-soft-lockup-in-nfs_wb_page.html)。
